...
function randCreat() {
    ...
    if (n < 10) {
        var e = null;
        if (n >= 9) {
            creatEnemys('enemy3', 600, 6, rand(0, 340 - 110), rand(4, speed), 10);
        } else if (n >= 6) {
            creatEnemys('enemy2', 300, 3, rand(0, 340 - 46), rand(4, speed), 6);
        } else {
            creatEnemys('enemy1', 100, 1, rand(0, 340 - 38), rand(4, speed), 5);
        }
    }
}
